...
#define TFT_COUNT 2        // Number of screens (1 or 2) - CHANGE FROM 1 TO 2
#define TFT1_CS 5          // TFT 1 chip select pin - CHANGE FROM -1
#define TFT2_CS 17         // TFT 2 chip select pin - CHANGE FROM -1
#define TFT_1_ROT 2        // TFT 1 rotation
